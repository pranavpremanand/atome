    ...
    <>
        ...
        <div className="pt-[13rem] pb-[5rem]">
          <div className="wrapper flex flex-col gap-7 justify-center h-full">
            ...
            <p data-aos="fade-up" className="text-white text-lg">
              {isWeb ? (
                <>
                  We design and develop user-centric websites that streamline
                  your business processes, boost engagement, and deliver
                  seamless experiences across devices. Our solutions are
                  tailored to meet your unique needs and drive measurable
                  results.
                </>
              ) : (
                <>
                  Our expert team creates innovative, user-friendly mobile
                  applications that bring your ideas to life. Whether it’s
                  Android, iOS, or cross-platform development, we ensure your
      ...
      <section className="pt-[4rem]">
        <h2 data-aos="fade-up" className="wrapper section-heading text-center">
          How Atome helps you deliver the best results
        </h2>
        <div
          data-aos="fade-up"
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            <div className="flex flex-col md:w-8/12 lg:w-9/12">
              <div className="md:px-[2.5rem]">
                <p className="md:text-lg text-white font-semibold">
                  At Atome, we deliver excellence across web and app
          ...
          >
            <div className="flex flex-col md:w-8/12 lg:w-9/12">
              <div className="md:px-[2.5rem]">
                <p className="md:text-lg text-white font-semibold">
                  At Atome, we deliver tailored solutions across industries.
