        ...
        <div className="relative z-10 h-full w-full">
          ...
          >
            ...
            <p className="max-w-5xl text-center text-[1.1rem]">
              Our expert team transforms ideas into cutting-edge digital
              solutions. With expertise in web and app development, UI/UX
              design, blockchain, and game development, we craft tailored
              experiences that drive growth. By understanding your unique needs,
              we deliver technology that fosters success and innovation.
            </p>
            ...
            {[
              {
                ...
                desc: "We prioritize honesty, accountability, and open communication to build lasting trust with our clients and partners.",
                Icon: MessagesSquare,
              },
              {
                title: "Innovation & Excellence",
                desc: "Harnessing creativity and cutting-edge technology, we craft solutions that push boundaries and exceed expectations.",
                Icon: PersonStanding,
              },
              {
                title: "Customer-Centric Approach",
                desc: "Your success drives us. We create tailored solutions that align with your vision and foster long-term growth.",
                Icon: Gem,
              },
            ].map(({ title, desc, Icon }) => (
              <div
          ...
          <div className="">
            <div className="grid sm:grid-cols-2 h-fit relative">
              ...
              <div className="py-[3rem] px-7 sm:aspect-square flex flex-col justify-between bg-gradient-to-tr sm:p-7 from-[#992FED] to-[#2F80ED]">
                <h4 className="text-xl font-semibold text-white">
                  Atome Partners with Optimizely for Enhanced Digital
                  Experiences
                </h4>
                <Link
                  to="/contact"
